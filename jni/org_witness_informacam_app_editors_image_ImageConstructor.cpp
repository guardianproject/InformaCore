...
#include <jni.h>
#include "org_witness_informacam_app_editors_image_ImageConstructor.h"

JNIEXPORT int JNICALL
Java_org_witness_informacam_app_editors_image_ImageConstructor_constructImage
...
Java_org_witness_informacam_app_editors_image_ImageConstructor_redactRegion(JNIEnv *env, jobject obj, jstring jstrSrcFilename, jstring jstrDestFilename, int left, int right, int top, int bottom, jstring jStrRedactionCommand) {
