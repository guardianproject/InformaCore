...
public class AddressBookImporterDialog extends AlertDialog {
	ListView fileList;
	Activity a;
	LayoutInflater li;
	View inner;
	String lastF;
	AddressBookImporterDialog abid;
	
	protected AddressBookImporterDialog(Context context) {
		super(context);
	}
	
	protected AddressBookImporterDialog(Activity a) {
		super(a);
		this.a = a;
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if(file.isDirectory()) {
				...
				if(file.getName().lastIndexOf(".") != -1) {
					...
					if(lastBit.equals(Constants.Media.Type.ICTD)) { // ".ictd"!
