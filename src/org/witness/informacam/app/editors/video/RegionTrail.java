...
public class RegionTrail implements OnActionItemClickListener {
	...
	public void onItemClick(QuickAction source, int pos, int actionId) {		
		...
		case 5:
			// redact
			setObscureMode(RegionTrail.OBSCURE_MODE_REDACT);			
			break;

		case 6:
			// pixelate
			setObscureMode(RegionTrail.OBSCURE_MODE_PIXELATE);
			break;

		default:
			if(pos > 6) {
				setObscureMode(RegionTrail.OBSCURE_MODE_IDENTIFY);
